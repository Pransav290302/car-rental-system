  ...
  <div class="div_zindex">
      <div class="row">
        ...
        <div class="banner_content">
            <h1 style="text-align:center ">Find the right car for you.</h1>
            <p style="colour: red " > We have more than a thousand cars for you to choose. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p style="colour: black">Most companies throughout the industry make a profit based on the type of cars that are rented. The rental cars are categorized into economy, compact, compact premium, premium and luxury. And customers are free to choose any car of their choice based on their purse and availability of such car at the time of reservation.

The proposed system provides a three tier login concept. It means that different users will login with different permission or privilege. Therefore the users are able to access different functionality of the proposed system.
</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>900+</h2>
...
{  ?>
        ...
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="assets/images/cama.png" alt="" /> </div>
